...
const Modal = (props) => {
  return (
    <div className='fixed h-full w-full z-10 ml-[-20px]'>
      ...
      <div className='flex flex-col px-5 pt-7 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[500px] w-11/12 h-[170px] bg-white rounded-lg text-baseTextPrimary border-2 border-baseTextPrimary '>
