...
const ErrorPage = () => {
  return (
    <div className='bg-baseBG h-screen flex flex-col justify-center items-center gap-y-4'>
      <div className='flex flex-col px-5 py-5 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[500px] w-11/12 rounded-lg items-center text-basePeach'>
